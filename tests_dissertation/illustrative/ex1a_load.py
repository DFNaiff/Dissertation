...
kc = "inf"
kcn = {"0.5":"12","1.5":"32","2.5":"52","inf":"SQE"}[kc]
data = np.load("ex1a_kcoef%s_data/tracking.npz"%kc,allow_pickle=True)
means = data["means"]
covs = data["covs"]
elbo = data["elbo"]
steps = data["steps"]
...
#fig4.savefig("/home/danilo/Danilo/Dissertação/Tex/figs/timegraphil1f.png"%training_interval)