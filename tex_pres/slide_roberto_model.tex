...
%\pause
\begin{block}{}
\centering{\textbf{Bayesian theory usually requires integration!}}
\end{block}
...
\begin{figure}
	\centering
	\captionsetup[subfigure]{labelformat=empty}
	\subfloat[Lumpy, means convergence.]{\label{fig11a}\includegraphics[width=0.4\linewidth]
		{figs/ex1b_mean.png}}
	\subfloat[Lumpy, covariances convergence.]{\label{fig11b}\includegraphics[width=0.4\linewidth]
		{figs/ex1b_cov.png}}
	
	
	\subfloat[Cigar, means convergence.]{\label{fig11a}\includegraphics[width=0.4\linewidth]
		{figs/ex4b_mean.png}}
	\subfloat[Cigar, covariances convergence.]{\label{fig11b}\includegraphics[width=0.4\linewidth]
		{figs/ex4b_cov.png}}
\end{figure}
\end{frame}
\begin{frame}
...
\centering
\captionsetup[subfigure]{labelformat=empty}
\subfloat[Student-t, means convergence.]{\label{fig11a}\includegraphics[width=0.4\linewidth]
	{figs/ex5b_mean.png}}
\subfloat[Student-t, covariances convergence.]{\label{fig11b}\includegraphics[width=0.4\linewidth]
	{figs/ex5b_cov.png}}
\end{figure}
\end{frame}
\begin{frame}
